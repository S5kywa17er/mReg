...
import { IProgramStructure, ICourseInProgram } from './program-structure.interface';
...
export class ProgramStructureService {
    ...
    getCourseInfo(courseid: any, Token?: string) {
        return this.http
            .requestGet(`api/course/getcourseinfo/${localStorage.getItem('lang')}/${courseid}`, Token)
